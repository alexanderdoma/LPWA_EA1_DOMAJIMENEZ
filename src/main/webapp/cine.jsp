...
<%
	Cine objCine = (Cine) session.getAttribute("data");
%>
			<div class="contenido-interno" id="contenido-interno">

				<h2><%= objCine.getRazonSocial() %></h2>
				<div class="cine-info">
					<div class="cine-info datos">
						<p><%= objCine.getDireccion() %> </p>
						<p><%= objCine.getTelefonos() %></p>
						<br/>
						<div class="tabla">
							<div class="fila">
					...
					<img src="img/cine/<%=objCine.getId() %>.2.jpg"/>
				...
				<div>
					<img style="float:left;" src="img/cine/<%= objCine.getId() %>.3.jpg"/>
